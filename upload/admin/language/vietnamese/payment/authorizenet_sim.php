...
$_['text_edit']             = 'Chỉnh sửa Authorize.Net (SIM)';
...
$_['entry_callback']        = 'Phản hồi từ URL';
...
// Help
$_['help_callback']			= 'Vui lòng đăng nhập và thiết lập tại đây <a href="https://secure.authorize.net" target="_blank" class="txtLink">https://secure.authorize.net</a>.';
$_['help_md5']				= 'Các tính năng MD5 Hash cho phép bạn xác nhận rằng một phản ứng giao dịch được an toàn từ Authorize.Net.Please login and set this at <a href="https://secure.authorize.net" target="_blank" class="txtLink">https://secure.authorize.net</a>.(Optional)';
