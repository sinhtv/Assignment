...
// Text
$_['text_success']					= 'Thành công: Bạn đã thay đổi chi tiết tài khoản PayPal Direct (UK)!';
$_['text_edit']                     = 'Chỉnh sửa PayPal Payflow Pro';
...
// Entry
$_['entry_vendor']					= 'Nhà cung cấp';
$_['entry_user']					= 'Người sử dụng';
$_['entry_password']				= 'Mật khẩu';
$_['entry_partner']					= 'Cộng tác viên';
...
// Error
$_['error_permission']				= 'Cảnh báo: Bạn không được phép thay đổi thanh toán PayPal Payment Pro (UK)!';
$_['error_vendor']					= 'Nhà cung cấp được yêu cầu!';
$_['error_user']					= 'Người sử dụng được yêu cầu!';
$_['error_password']				= 'Mật khẩu được yêu cầu!';
$_['error_partner']					= 'Cộng tác viên được yêu cầu!';
