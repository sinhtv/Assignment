...
<script src="view/plugins/ckfinder/ckfinder.js" type="text/javascript" ></script>
<script src="view/plugins/ckeditor/ckeditor.js" type="text/javascript" ></script>
<script src="view/plugins/ckeditor/adapters/jquery.js" type="text/javascript" ></script>
