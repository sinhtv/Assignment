...
class ControllerStep2 extends Controller {
	...
	public function index() {
		...
		$data['ckeditor'] = DIR_OPENCART . 'admin/view/plugins/ckeditor';
		$data['ckfinder'] = DIR_OPENCART . 'admin/view/plugins/ckfinder';
	...
	private function validate() {
		...
		if (!is_writable(DIR_OPENCART . 'admin/view/plugins/ckeditor/')) {
			$this->error['warning'] = 'Warning: Ckeditor directory needs to be writable for OpenCart to work!';
		}

		if (!is_writable(DIR_OPENCART . 'admin/view/plugins/ckfinder/')) {
			$this->error['warning'] = 'Warning: Ckfinder directory needs to be writable for OpenCart to work!';
		}
